...
public class ArithmeticOps4 {
	...
	public static void main(String[] args) {
		 ...
		 * Create anint variable called stepOne. 
		 ...
		 * Let's print out the value of the last step as:
		 * "The magic number is _ !" Now try running your code! 
